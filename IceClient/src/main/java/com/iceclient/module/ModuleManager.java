...
public class ModuleManager {
   ...
   public static void init() {
      ...
      tag(register(new SchematicModule()), ModuleCategory.PRINTER, (String)null);
      tag(register(new Printer()), ModuleCategory.PRINTER, (String)null);
      tag(register(new MissingBlockEspModule()), ModuleCategory.PRINTER, (String)null);
      tag(register(new AutoTickModule()), ModuleCategory.PRINTER, (String)null);
      ...
      tag(register(new HideSchematicaGui()), ModuleCategory.PRINTER, (String)null);
      ...
      tag(register(new EasyPlace()), ModuleCategory.PRINTER, (String)null);
      tag(register(new SchemTransform()), ModuleCategory.PRINTER, (String)null);
      tag(register(new com.iceclient.module.modules.schematic.SchemKeybinds()), ModuleCategory.PRINTER, (String)null);
      tag(register(new com.iceclient.module.modules.schematic.AutoYLevel()), ModuleCategory.PRINTER, (String)null);
      tag(register(new com.iceclient.module.modules.schematic.KeepFly()), ModuleCategory.PRINTER, (String)null);
      tag(register(new SelectionTool()), ModuleCategory.PRINTER, (String)null);
