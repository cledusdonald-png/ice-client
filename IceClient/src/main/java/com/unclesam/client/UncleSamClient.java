...
import com.unclesam.client.gui.MainMenuHandler;
import com.unclesam.client.module.ModuleManager;
import com.unclesam.client.module.modules.factions.SchemCommand;
...
@Mod(
   modid = "unclesamclient",
   name = "Ice Client",
   version = "0.1.0",
   acceptedMinecraftVersions = "[1.8.9]"
)
public class UncleSamClient {
   public static final String MODID = "unclesamclient";
   ...
   public void init(FMLInitializationEvent event) {
      ...
      com.unclesam.client.command.MacroCommand.register();
      ConfigManager.load();
      Runtime.getRuntime().addShutdownHook(new Thread(new Runnable() {
         public void run() {
            ConfigManager.save();
         }
      }, "UncleSam-config-save"));
   }
